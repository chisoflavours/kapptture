...
ActiveRecord::Schema.define(version: 20170811134400) do
  ...
  add_index "comments", ["kapp_id"], name: "index_comments_on_kapp_id"
  ...
  add_index "creators", ["phone"], name: "index_creators_on_phone", unique: true
  ...
  create_table "kapps", force: :cascade do |t|
    t.string   "title"
    t.text     "description"
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
